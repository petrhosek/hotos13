...
lifting'' code is definitely part of the TCB.  The exposition should be
clear that we are referring to the additional TCB needed to implement
the VM.}  The benefits of our approach are mainly structural; since the
