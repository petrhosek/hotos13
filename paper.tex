...
System virtual machines require the user to run an entire operating
...
desktop and client applications.  Application virtual machines on the
other hand are typically targeting only a single language (or language
family) making them unsuitable for native applications.
...
should be possible to add support for other operating systems if needed.}
\end{abstract}
